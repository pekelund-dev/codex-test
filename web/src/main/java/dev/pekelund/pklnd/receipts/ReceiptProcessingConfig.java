...
public class ReceiptProcessingConfig {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ReceiptProcessingConfig.class);
    ...
    public VertexAiGeminiChatOptions receiptGeminiChatOptions(Environment environment) {
        ...
        LOGGER.info("Configured Vertex AI Gemini chat settings - project: {}, location: {}, model: {}",
    ...
    @Bean
    @ConditionalOnBean({Firestore.class, FirestoreProperties.class})
    @ConditionalOnMissingBean
    public ReceiptExtractionRepository receiptExtractionRepository(Firestore firestore,
        ...
        return new ReceiptExtractionRepository(firestore, firestoreProperties.getReceiptsCollection());
    }
}
