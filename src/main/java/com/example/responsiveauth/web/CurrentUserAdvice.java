...
import com.example.responsiveauth.firebase.DisplayNameUserDetails;
...
public class CurrentUserAdvice {
    ...
    public UserProfile userProfile(Authentication authentication) {
        ...
        } else if (principal instanceof DisplayNameUserDetails displayNameUserDetails) {
            displayName = displayNameUserDetails.getDisplayName();
