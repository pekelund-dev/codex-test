...
echo ""
echo "Test endpoints:"
echo "  GET  http://localhost:8081/api/parsers"
echo "  POST http://localhost:8081/api/parsers/{parser-id}/parse"
echo "  POST http://localhost:8081/local-receipts/parse (test profile)"
echo ""
