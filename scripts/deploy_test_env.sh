...
WEB_OAUTH_CLIENT_ID_SECRET="${WEB_OAUTH_CLIENT_ID_SECRET:-pklnd-oauth-client-id-${TEST_ENV_NAME}}"
WEB_OAUTH_CLIENT_SECRET_SECRET="${WEB_OAUTH_CLIENT_SECRET_SECRET:-pklnd-oauth-client-secret-${TEST_ENV_NAME}}"
AI_STUDIO_API_KEY_SECRET="${AI_STUDIO_API_KEY_SECRET:-pklnd-ai-studio-api-key-${TEST_ENV_NAME}}"
...
SPRING_PROFILES_ACTIVE="${SPRING_PROFILES_ACTIVE:-prod}" \
WEB_OAUTH_CLIENT_ID_SECRET="${WEB_OAUTH_CLIENT_ID_SECRET:-}" \
WEB_OAUTH_CLIENT_SECRET_SECRET="${WEB_OAUTH_CLIENT_SECRET_SECRET:-}" \
