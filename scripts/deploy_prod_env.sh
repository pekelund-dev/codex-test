...
WEB_OAUTH_CLIENT_ID_SECRET="${WEB_OAUTH_CLIENT_ID_SECRET:-$(tf_output oauth_client_id_secret)}"
WEB_OAUTH_CLIENT_SECRET_SECRET="${WEB_OAUTH_CLIENT_SECRET_SECRET:-$(tf_output oauth_client_secret_secret)}"
AI_STUDIO_API_KEY_SECRET="${AI_STUDIO_API_KEY_SECRET:-$(tf_output ai_studio_api_key_secret)}"
