...
RECEIPT_FIRESTORE_ITEM_COLLECTION="${RECEIPT_FIRESTORE_ITEM_COLLECTION:-receiptItems}"
RECEIPT_FIRESTORE_ITEM_STATS_COLLECTION="${RECEIPT_FIRESTORE_ITEM_STATS_COLLECTION:-receiptItemStats}"
